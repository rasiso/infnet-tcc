...
-- -----------------------------------------------------
-- Table `avaliacaoinfnet`.`perfil`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `avaliacaoinfnet`.`perfil` (
  `id` BIGINT(20) NOT NULL,
...
-- -----------------------------------------------------
-- Table `avaliacaoinfnet`.`usuario_perfil`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `avaliacaoinfnet`.`usuario_perfil` (
  `idperfil` BIGINT(20) NOT NULL,
  `idusuario` BIGINT(20) NOT NULL,
  PRIMARY KEY (`idperfil`, `idusuario`),
  INDEX `fk_usuario_perfil_perfil1_idx` (`idperfil` ASC),
  INDEX `fk_usuario_perfil_usuario1_idx` (`idusuario` ASC),
  CONSTRAINT `fk_usuario_perfil_perfil1`
    FOREIGN KEY (`idperfil`)
    REFERENCES `avaliacaoinfnet`.`perfil` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
